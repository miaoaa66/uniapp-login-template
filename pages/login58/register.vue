<template>
	<view class="content">
		<view class="tip-box">
			<text class="tip">用户注册</text>
			<text class="sub-tip">Sign Up</text>
		</view>
		...
		<view class="row-input">
			...
			<view class="input-box">
				...
				<input placeholder="name" maxlength="4" />
			</view>
		</view>
		<view class="row-input">
		...
		<text class="menu-link" @click="gotoLogin">用户登录</text>
	</view>
</template>
