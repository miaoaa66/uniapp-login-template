		...
		<view class="form-box">
			<view class="row-input">
				...
				<view class="input-box">
					...
					<image mode="aspectFit" v-show="phone==''?false:true" @click="close" src="https://mp-dc95b988-31eb-4147-82e1-c097f0893940.cdn.bspapp.com/登录模板库/login3/login3_close.png"></image>
				</view>
			</view>
			<view class="row-input2">
				...
				<view class="input-box">
					...
					<view class="code" @click="getCode">Send code</view>
				</view>
			</view>
			<view class="row-input">
				<text class="tip">{{password!=''?'Password':''}}</text>
				<view class="input-box">
					<input v-model="password" maxlength="18" placeholder="Password" password
